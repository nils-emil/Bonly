...
@RestController
@RequestMapping("/api")
public class AdvertisementAnswersResource {

    private final Logger log = LoggerFactory.getLogger(AdvertisementAnswersResource.class);
    ...
    public AdvertisementAnswersResource(AdvertisementAnswersService advertisementAnswersService) {
     ...
     */
    @PostMapping("/advertisement-answers")
    public ResponseEntity<AdvertisementAnswersDTO> createAdvertisementAnswers(@RequestBody AdvertisementAnswersDTO advertisementAnswersDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/advertisement-answers/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/advertisement-answers")
     ...
     */
    @GetMapping("/advertisement-answers")
     ...
     */
    @GetMapping("/advertisement-answers/{id}")
     ...
     */
    @DeleteMapping("/advertisement-answers/{id}")
