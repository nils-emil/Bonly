...
@RestController
@RequestMapping("/api")
public class AdvertisementAnswersManagementResource {

    private final Logger log = LoggerFactory.getLogger(AdvertisementAnswersManagementResource.class);
    ...
    public AdvertisementAnswersManagementResource(AdvertisementAnswersService advertisementAnswersService) {
