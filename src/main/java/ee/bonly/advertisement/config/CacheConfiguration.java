...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ee.bonly.advertisement.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ee.bonly.advertisement.repository.UserRepository.USERS_BY_EMAIL_CACHE);
