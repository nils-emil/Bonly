...
import ee.bonly.advertisement.config.audit.AuditEventConverter;
import ee.bonly.advertisement.domain.PersistentAuditEvent;
...
import static ee.bonly.advertisement.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
